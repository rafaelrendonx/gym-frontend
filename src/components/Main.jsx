    ...
    return (
        <div className='px-3'>
            ...
            <section>
                ...
                <div className="row row-cols-1 row-cols-lg-3 align-items-stretch px-3">
                    ...
                    <div className='container'>
                        ...
                        <button className='btn bg-transparent text-main' onClick={navigateTo} name="maquinas">Máquinas</button>
                        </div>
                    </div>
                    ...
                    <div className='container'>
                        ...
                        <div className="middle">
                        <button className='btn bg-transparent text-main' onClick={navigateTo} name="calistenia">Calistenia</button>
                        </div>
                    </div>
                    ...
                    <div className='container'>
                        ...
                        <div className="middle">
                            <button className='btn bg-transparent text-main' onClick={navigateTo} name="pesas">Pesas</button>
                        </div>
                    </div>
